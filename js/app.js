...
// Higher weight = higher chance to roll.
const nonSnowyWeather = [
    { value: "Sunny / Firm", weight: 35 },
    { value: "Sunny / Good", weight: 25 },
    { value: "Cloudy / Firm", weight: 20 },
    { value: "Cloudy / Good", weight: 10 },
    { value: "Rainy / Soft", weight: 7 },
    { value: "Rainy / Heavy", weight: 3 }
];

const snowyWeather = [
    { value: "Snowy / Good", weight: 4 },
    { value: "Snowy / Soft", weight: 1 }
];

// Helper function to pick an item based on its assigned weight
...
    
    // Updated line utilizing the weighted randomizer
    const finalWeather = getWeightedRandom(availableWeather);
